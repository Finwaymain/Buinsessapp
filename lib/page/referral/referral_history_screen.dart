...
class _ReferralHistoryScreenState extends State<ReferralHistoryScreen> {
  ...
  Future<void> _fetchReferralHistory() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${API.referralHistory}?driver_id=$driverId'),
        headers: API.header,
      );
  ...
  Color _colorForCategory(String category) {
    ...
    return AppThemeData.primary400;
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            onPressed: () => Get.to(() => const TransactionServiceHistoryScreen()),
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              color: isDark ? AppThemeData.surface50Dark : AppThemeData.grey50,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(color: isDark ? AppThemeData.grey100Dark : AppThemeData.grey200),
            ),
            child: Column(
