...
class TransactionHistoryDisplay {
  static String categoryTitle(TransactionHistoryData data) {
  ...
  static String counterpartyName(TransactionHistoryData data) {
    ...
    return 'Fiinway Driver Wallet';
  }

  static String displayDate(TransactionHistoryData data) {
  ...
  static String statusLabel(TransactionHistoryData data) {
    ...
    if (status == 'success' || status == 'paid' || status == 'completed' || status == 'yes') {
      return 'Paid';
    }
  ...
  static String iconType(TransactionHistoryData data) {
    ...
    if (combined.contains('subscription') || combined.contains('plan')) return 'subscription';
