...
import 'package:cabme_driver/page/wallet/utils/transaction_history_display.dart';
...
class WalletTransactionsTab extends StatelessWidget {
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return _TransactionCard(
                          ...
                          isDark: isDark,
                          onTap: () => _showReceiptSheet(context, controller.historyList[index], isDark),
                        );
                      },
                    ),
            ),
  ...
  void _showReceiptSheet(BuildContext context, TransactionHistoryData data, bool isDark) {
