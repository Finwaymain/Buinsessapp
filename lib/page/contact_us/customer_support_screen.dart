    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (body['success'] == 'success' && body['data'] != null) {
          final bizApp = body['data']['business_app'];
          if (bizApp != null) {
            setState(() {
              if (bizApp['whatsapp_number'] != null && bizApp['whatsapp_number'].toString().trim().isNotEmpty) {
                whatsappNumber = bizApp['whatsapp_number'].toString().trim();
              }
              if (bizApp['call_number'] != null && bizApp['call_number'].toString().trim().isNotEmpty) {
                callNumber = bizApp['call_number'].toString().trim();
              }
            });
          }
        }
      ...
      debugPrint('Error fetching business customer care numbers: $e');
    } finally {
      if (mounted) {
    ...
    try {
      if (await canLaunchUrl(whatsappUri)) {
        ...
        if (await canLaunchUrl(fallbackUri)) {
          ...
          Get.snackbar('WhatsApp Not Installed'.tr, 'Please install WhatsApp to chat with business partner support.'.tr);
        }
      }
    } catch (e) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Need assistance with rides, service bookings, payouts, or account queries? Contact our team directly.'.tr,
                          style: const TextStyle(
                  ...
                  Card(
                    ...
                    child: InkWell(
                      borderRadius: BorderRadius.circular(16),
                      onTap: () => Get.to(() => const SupportChatScreen(userType: 'business')),
                      child: Padding(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Realtime partner support • Dedicated desk'.tr,
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: mutedColor,
                  ...
                  Center(
                    child: Text(
                      'Fiinway Business Support • Partner Helpline'.tr,
                      style: TextStyle(
                        fontSize: 12,
                        color: mutedColor,
                        fontFamily: AppThemeData.medium,
