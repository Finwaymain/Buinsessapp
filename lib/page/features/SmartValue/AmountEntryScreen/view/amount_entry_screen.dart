...
//   }) : super(key: key);
//
//   String _getUserName(String data) {
//     final names = [
//       'John Doe',
//       'Jane Smith',
//       'Mike Johnson',
...
//       'David Brown'
//     ];
//     final index = data.hashCode % names.length;
//     return names[index.abs()];
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//                     child: Text(
//                       _getUserName(paymentData).substring(0, 1),
//                       style: TextStyle(
//                         fontSize: 24,
//                         fontWeight: FontWeight.bold,
//                         color: AppThemeData.primary200,
