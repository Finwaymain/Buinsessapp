...
//   Future<void> processToAmountEntry() async {
//     String paymentData = manualInput.value.trim();
//
//     if (paymentData.isEmpty) {
//       Get.snackbar(
//         'Error',
//         'Please enter a valid number or scan QR code',
...
//     // Check if input is valid (10 digits for mobile or valid card format)
//     return input.length >= 10 && RegExp(r'^[0-9]+$').hasMatch(input);
//   }
// }