...
//
// class MPinChangeScreen extends StatelessWidget {
//   const MPinChangeScreen({Key? key}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     final controller = Get.put(MPinChangeController());
...
//                               const SizedBox(height: 24),
//
//                               // Title and Description - Fixed Obx usage
//                               GetBuilder<MPinChangeController>(
...
//                       const SizedBox(height: 40),
//
//                       // Step Indicator - Fixed Obx usage
//                       GetBuilder<MPinChangeController>(
...
//                       const SizedBox(height: 40),
//
//                       // PIN Input Section - Fixed Obx usage
//                       AnimatedSwitcher(
//                         duration: const Duration(milliseconds: 300),
//                         child: GetBuilder<MPinChangeController>(
//                           builder: (controller) => _buildPinInputSection(
//                               controller, isDark, controller.currentStep.value),
//                         ),
//                       ),
//
//                       const SizedBox(height: 40),
//
//                       // Security Tips (only show on first step) - Fixed Obx usage
//                       GetBuilder<MPinChangeController>(
//                         builder: (controller) => controller.currentStep.value ==
//                             0
//                             ? FadeTransition(
//                           opacity: controller.fadeAnimation,
//                           child: Container(
...
//                 border: Border.all(
//                   color:
//                   _getPinFieldBorderColor(controller, index, step, isDark),
//                   width: 2,
//                 ),
//                 boxShadow: [
//                   if (!isDark)
...
//         const SizedBox(height: 20),
//
//         // Show/Hide PIN Toggle - Fixed Obx usage
//         GestureDetector(
//           onTap: toggleVisibility,
//           child: GetBuilder<MPinChangeController>(
//             builder: (controller) => Row(
