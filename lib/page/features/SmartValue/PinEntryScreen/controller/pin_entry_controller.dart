...
class PinEntryController extends GetxController {
  ...
  void onInit() {
    ...
    getNameByAccountNumber("${Constant.getUserData().userData?.acNo}");
  }
  ...
  Future<void> processPayment(
    ...
    try {
      ...
      Map bodyParams = {
        "sender_ac_no":"${Constant.getUserData().userData?.acNo}",
...
//       bool isSuccess = Random().nextBool() || Random().nextBool();
//
//       // Navigate to payment result screen
//       Get.offAll(() => PaymentResultScreen(
//         paymentData: paymentData,
//         amount: amount,
//         isQRPayment: isQRPayment,
//         isSuccess: isSuccess,
