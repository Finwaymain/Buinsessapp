...
const Map<String, ServiceCategoryStyle> kCategoryStyles = {
  'Transport & Mobility': ServiceCategoryStyle(Icons.directions_car_rounded, Color(0xFF1E88E5), Color(0xFFE3F2FD)),
  'Delivery & Logistics': ServiceCategoryStyle(Icons.local_shipping_rounded, Color(0xFFFB8C00), Color(0xFFFFF3E0)),
  'Food & Kitchen': ServiceCategoryStyle(Icons.restaurant_rounded, Color(0xFFE65100), Color(0xFFFFF3E0)),
  'Marketplace & Sellers': ServiceCategoryStyle(Icons.store_rounded, Color(0xFF43A047), Color(0xFFE8F5E9)),
  'Healthcare': ServiceCategoryStyle(Icons.favorite_rounded, Color(0xFFE53935), Color(0xFFFFEBEE)),
  'Education': ServiceCategoryStyle(Icons.school_rounded, Color(0xFF2E7D32), Color(0xFFE8F5E9)),
  'Green Exchange': ServiceCategoryStyle(Icons.recycling_rounded, Color(0xFF388E3C), Color(0xFFE8F5E9)),
  'Travel & Hospitality': ServiceCategoryStyle(Icons.flight_rounded, Color(0xFF00897B), Color(0xFFE0F2F1)),
  'Home Services': ServiceCategoryStyle(Icons.home_rounded, Color(0xFF1E88E5), Color(0xFFE3F2FD)),
  'Professional Services': ServiceCategoryStyle(Icons.work_rounded, Color(0xFF5E35B1), Color(0xFFEDE7F6)),
  ...
  'Personal Home Assistance': ServiceCategoryStyle(Icons.family_restroom_rounded, Color(0xFF7B1FA2), Color(0xFFEDE7F6)),
  ...
  'Technology Services': ServiceCategoryStyle(Icons.computer_rounded, Color(0xFF455A64), Color(0xFFECEFF1)),
  'Personal Services': ServiceCategoryStyle(Icons.content_cut_rounded, Color(0xFFC2185B), Color(0xFFFCE4EC)),
  ...
  'Miscellaneous': ServiceCategoryStyle(Icons.category_rounded, Color(0xFFEF6C00), Color(0xFFFFF3E0)),
};
