...
class HomeBannerSlider extends StatefulWidget {
  final String appType; // 'driver' or 'user'
...
class _HomeBannerSliderState extends State<HomeBannerSlider> {
  ...
  Future<void> _fetchBanners() async {
    try {
      ...
      debugPrint("Error fetching driver banners: $e");
    }
  ...
  Future<void> _onBannerTap(BannerModelData banner) async {
    ...
    try {
      ...
      final driverId = userData?.id?.toString() ?? '';
      final name = '${userData?.prenom ?? ''} ${userData?.nom ?? ''}'.trim();

      final queryParams = Map<String, String>.from(uri.queryParameters);
      if (phone.isNotEmpty) queryParams['phone'] = phone;
      if (driverId.isNotEmpty) queryParams['driver_id'] = driverId;
      ...
      debugPrint("Could not launch driver banner url ($link): $e");
    }
  }
