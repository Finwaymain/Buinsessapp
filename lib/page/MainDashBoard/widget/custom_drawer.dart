        ...
        child: Column(
          children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  isLogin
                                      ? "${(dashBoardController.userModel.value.userData?.phone ?? 'guest')}@fiinway.com"
                                          .toLowerCase()
                                      : "guest@fiinway.com"
                                          .toLowerCase(),
                                  style: TextStyle(
            ...
            if (Constant.subscriptionModel == true || Constant.adminCommission?.statut == "yes")
              Visibility(
                visible: dashBoardController.userModel.value.userData?.subscriptionPlanId?.isNotEmpty == true,
                child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
                  child: SubscriptionPlanWidget(
                    onClick: () {
                      Get.delete<SubscriptionController>();
                      Get.to(subs.SubscriptionPlanScreen(
                        isbackButton: true,
                      ));
                    },
                    userModel: dashBoardController.userModel.value,
                  ),
                ),
              ),
