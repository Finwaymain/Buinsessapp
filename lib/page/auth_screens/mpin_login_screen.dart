...
import 'package:cabme_driver/page/auth_screens/phone_otp_screen.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => Get.offAll(() => PhoneEntryScreen(mode: 'signup')),
        ),
      ),
      body: SafeArea(
              ...
              Obx(() => ButtonThem.buildButton(
                    ...
                    onPress: controller.isLoading.value
                        ...
                        : () async {
                            ...
                            if (mpin.length != 4) {
                              ShowToastDialog.showToast('Please enter your 4-digit MPIN.'.tr);
                              return;
                            }
                            final user = await controller.loginByMpin(widget.phone, mpin, userCat: 'driver');
                            if (user != null) {
