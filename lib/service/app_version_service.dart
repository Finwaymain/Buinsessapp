...
class AppVersionService {
  ...
  static Future<void> checkAppVersion({
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (body['success'] == 'success' && body['data'] != null) {
          ...
          final String message = data['message']?.toString() ??
              'A new version of the Partner app is available on the Play Store. Please update now to continue.';
          ...
          final String maintenanceMsg = data['maintenance_message']?.toString() ??
              'Partner services are currently undergoing maintenance.';
      ...
      debugPrint('Driver AppVersionService check error: $e');
    }
  }

  /// Non-Dismissible Compulsory Update Screen for Driver App
